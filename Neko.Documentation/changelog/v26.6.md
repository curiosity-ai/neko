...
15px/600 titles and near-white 15px links. Footer **trust badges accept image
icons** — an `icon:` that points at a logo file (`/assets/…svg|png|webp`) renders
as a ~28px image instead of a glyph chip — and the copyright line carries a small
cookie glyph, matching curiosity.ai. This is achieved by not capping the content
