...
call-to-action buttons, and a full-width footer. The page/header/CTA palette is
driven by `theme.base` (light) and `theme.dark` (dark), so blog mode **supports
both light and dark mode** and keeps the theme toggle. Header CTAs are
