...
out around its rounded corners and through the strip above it. The header is now
a square, full-width bar — left-aligned with the release body and stretching to
the right edge — that pins flush against the top of the scroll area, so the
current release's entries slide cleanly underneath it as you scroll.
:::
