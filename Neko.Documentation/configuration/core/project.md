...
| `blog` | The marketing-site look (as on [curiosity.ai](https://curiosity.ai)): a light, borderless header, the logo used on its own as a wordmark, pill-shaped search and [`actions`](#actions) buttons, a single (light) palette with no theme toggle, a light page background, and the full-width [marketing footer](#footer). |
