...
The latest release of TailDocs is `v{{ version }}`.

You can find which version you have installed by running the command [`taildocs --version`](/guides/cli.md).

The entire release archive of TailDocs is available on [NPM](https://www.npmjs.com/package/taildocsapp) and [NuGet](https://nuget.org/packages/taildocsapp).

TailDocs does not have a fixed release cycle:
...
!!!
Do have a suggestion for a new feature in TailDocs? Please open an [issue](https://github.com/taildocsapp/taildocs/issues) and let's chat. :icon-comment:
!!!
...
**Released:** [2026-02-10](https://github.com/taildocsapp/taildocs/releases/tag/v3.12.0)
...
**Released:** [2025-07-02](https://github.com/taildocsapp/taildocs/releases/tag/v3.11.0)
...
1. Add keyboard hint into Search field, see [#762](https://github.com/taildocsapp/taildocs/discussions/762)
1. Improve templating support within [`footer.copyright`](/configuration/project.md#copyright) project setting
1. Hide the placeholder text in the Search and Filter input fields when focused, see [#762](https://github.com/taildocsapp/taildocs/discussions/762)
...
1. Fixed search input  attribute value not being rendered, see [#764](https://github.com/taildocsapp/taildocs/discussions/764)
...
**Released:** [2025-06-08](https://github.com/taildocsapp/taildocs/releases/tag/v3.10.0)
...
1. Add unique `id` values to important template elements, see [#538](https://github.com/taildocsapp/taildocs/discussions/538), [#639](https://github.com/taildocsapp/taildocs/discussions/639) and [#640](https://github.com/taildocsapp/taildocs/discussions/640)
...
1. Fixed exception being thrown if `order` set with a huge number, see [#751](https://github.com/taildocsapp/taildocs/discussions/751)
...
1. Fixed lists with [lowercase](/components/list.md#lowercase-letters) letters and [roman numerals](/components/list.md#lowercase-roman-numerals) not rendered correctly, see [#760](https://github.com/taildocsapp/taildocs/discussions/760), see `v3.10.1`
1. Fixed main layout background color that does not match sidebar background color, see [#759](https://github.com/taildocsapp/taildocs/discussions/759), see `v3.10.1`

+++

## v3.9.0

**Released:** [2025-05-28](https://github.com/taildocsapp/taildocs/releases/tag/v3.9.0)
...
1. New `question` [callout](components/callout.md#samples) component variant, see [#223](https://github.com/taildocsapp/taildocs/discussions/223)
...
1. `layout: page` failing to be recognized on Pages within sub-folders, see [#732](https://github.com/taildocsapp/taildocs/discussions/732)
...
**Released:** [2025-05-05](https://github.com/taildocsapp/taildocs/releases/tag/v3.8.0)
...
1. Support Description Lists with Single-Space After Colon, see [#740](https://github.com/taildocsapp/taildocs/issues/740)
1. Upgrade [Mermaid](/components/mermaid.md) to the latest v11.6.0 release, see [#627](https://github.com/taildocsapp/taildocs/issues/627), [#656](https://github.com/taildocsapp/taildocs/issues/656), and [#716](https://github.com/taildocsapp/taildocs/issues/716)
...
**Released:** [2025-04-07](https://github.com/taildocsapp/taildocs/releases/tag/v3.7.0)

There were **6 changes** in TailDocs `v3.7.0`.
...
**Released:** [2024-09-17](https://github.com/taildocsapp/taildocs/releases/tag/v3.6.0)
...
1. New link directly into Tab, see [#651](https://github.com/taildocsapp/taildocs/discussions/651)
1. Resolve links to Panel titles, see [#389](https://github.com/taildocsapp/taildocs/discussions/389), [#401](https://github.com/taildocsapp/taildocs/discussions/401), and [#659](https://github.com/taildocsapp/taildocs/discussions/659)
+++ Fixed :icon-bug:
1. Folder name starting with `1. ` creates raw HTML label in nav tree, see [#650](https://github.com/taildocsapp/taildocs/discussions/650)
1. Sidebar filter does not work for CamelCase titles, see [#696](https://github.com/taildocsapp/taildocs/discussions/696)
1. CI build process failing, see [#708](https://github.com/taildocsapp/taildocs/discussions/708)
+++
...
**Released:** [2023-08-23](https://github.com/taildocsapp/taildocs/releases/tag/v3.2.0)
...
+++ Fixed :icon-bug:
1. Custom attributes on an image cause TailDocs to skip handling of component as a figure image
...
1. Render icon on outbound link only if link contains plain or basic Markdown text, see [#589](https://github.com/taildocsapp/taildocs/issues/589)
+++
...
1. Update the RU translation file, see [#586](https://github.com/taildocsapp/taildocs/issues/586)
1. Upgrade to latest release of [Mermaid](/components/mermaid.md) see [#585](https://github.com/taildocsapp/taildocs/issues/585)
1. Add cache buster to `_watch` scripts during `taildocs start`
...
+++ Fixed :icon-bug:
1. Not supported value WARNING on first build with new locale, see [#573](https://github.com/taildocsapp/taildocs/issues/573)
1. Finish translation file updated
1. `html lang=\"en\"` attribute not updated if locale changes, see [#574](https://github.com/taildocsapp/taildocs/issues/574)
+++
...
1. New [`-n`](guides/cli.md#taildocs-start) flag to prevent default web browser from being opened, see [#323](https://github.com/taildocsapp/taildocs/discussions/323)
1. New [`taildocs clean`](guides/cli.md#taildocs-clean) CLI command
1. New named regions with content, see [#368](https://github.com/taildocsapp/taildocs/discussions/368)
1. New {%{`{{ nonce }}`}%} token for cache busting URLs in templates, see [#324](https://github.com/taildocsapp/taildocs/issues/324)
1. New Inter and system based font-family, see [#179](https://github.com/taildocsapp/taildocs/discussions/179)
...
1. Updated all Prism languages and created new dependency tree process, see [#446](https://github.com/taildocsapp/taildocs/issues/446)
1. Argh... Poppins font doesn't support non-latin character glyphs (cyrillic), see [#179](https://github.com/taildocsapp/taildocs/discussions/179)
1. Use Inter font
1. Revise Plausible default script `plausible.js` to `script.js`
1. Remove Page `Edit` button on generated Welcome page
1. Links with icon that are images get empty alt attribute, see [#523](https://github.com/taildocsapp/taildocs/issues/523)
...
+++ Fixed :icon-bug:
1. JavaScript error if one stacked Panel is missing content, see [#388](https://github.com/taildocsapp/taildocs/issues/388)
1. `--override` command fails when used with a templating data object, see [#509](https://github.com/taildocsapp/taildocs/issues/509)
1. Editor icons are not rendered after `monaco` has been upgraded
1. Propagate `visibility` to all nested pages in `watch` mode
1. Messed up meta tag content value generation with escaped sequence, see [#513](https://github.com/taildocsapp/taildocs/discussions/513)
1. `mark-github` icon issue in ref and file components, see [#517](https://github.com/taildocsapp/taildocs/issues/517)
...
**Released:** [2022-07-14](https://github.com/taildocsapp/taildocs/releases/tag/v2.4.0)
...
1. New [`host`](/configuration/project.md#integration-plausible-host) config on `integrations.plausible`. See [#272](https://github.com/taildocsapp/taildocs/discussions/272).
+++ Fixed :icon-bug:
1. Extra phantom `index.md` file if TailDocs output path ends with a slash char.
...
1. Pressing enter on search results creates invalid url. See [#333](https://github.com/taildocsapp/taildocs/discussions/333).
1. Parent folder prefixed with an `_` underscore do not build properly. See [#336](https://github.com/taildocsapp/taildocs/issues/336).
1. Broken link to same page when `generator.trailingSlash` is `false`.
+++

## v2.3.0

**Released:** [2022-05-03](https://github.com/taildocsapp/taildocs/releases/tag/v2.3.0)

+++ New :icon-shield-check:
1. Support for full relative URL pathing. See [#14](https://github.com/taildocsapp/taildocs/discussions/14), [#133](https://github.com/taildocsapp/taildocs/discussions/133), [#194](https://github.com/taildocsapp/taildocs/discussions/194), [#222](https://github.com/taildocsapp/taildocs/discussions/222), [#233](https://github.com/taildocsapp/taildocs/discussions/233), and [#276](https://github.com/taildocsapp/taildocs/issues/276).
...
1. Editor font request does not respect `base` path. See [#318](https://github.com/taildocsapp/taildocs/discussions/318).
1. Syntax errors in yaml files results in corrupt category URLs. See [#316](https://github.com/taildocsapp/taildocs/discussions/316).
1. `links` to the index document in the mobile sidebar footer not being resolved.
1. **.yml** files excluded from deploy even if explicitly declared in `include`. See [#311](https://github.com/taildocsapp/taildocs/discussions/311).
...
To revert to the previous functionality, set the `generator.paths` config to `root` in your project **taildocs.yml** file.
...
**Released:** [2022-03-30](https://github.com/taildocsapp/taildocs/releases/tag/v2.2.0)

+++ New :icon-shield-check:
1. [`generator.recase`](/configuration/project.md#generator) project config to recase file and folder names. See [#302](https://github.com/taildocsapp/taildocs/issues/302).
1. Official TailDocs docker images published to [DockerHub](https://hub.docker.com/repository/docker/taildocsapp/taildocs). See [#122](https://github.com/taildocsapp/taildocs/issues/122).
1. New `@latest` tag to be used in your [taildocs-action.yml](/guides/github-actions/#step-1-add-taildocs-actionyml-workflow) configuration.
1. GitHub Action annotation to announce availability of TailDocs v2, only if using TailDocs v1.
+++ Fixed :icon-bug:
...
**Released:** [2022-03-22](https://github.com/taildocsapp/taildocs/releases/tag/v2.1.0)

+++ New :icon-shield-check:
1. Deploy `.html` and `.htm` files from [`input`](/configuration/project.md#input) to [`output`](/configuration/project.md#output) by default. See [#302](https://github.com/taildocsapp/taildocs/issues/302).
1. Apply generic attribute syntax to TailDocs generated [`<table>`](/components/table.md#compact) element.
+++ Fixed :icon-bug:
1. Project [`include`](/configuration/project.md#include) config not including pages if `_*` configured. See [#296](https://github.com/taildocsapp/taildocs/discussions/296).
+++

## v2.0.0

**Released:** [2022-03-14](https://github.com/taildocsapp/taildocs/releases/tag/v2.0.0)

+++ New :icon-shield-check:
1. Redesign of Search results.
1. Page content live editor during [`taildocs start`](/guides/cli.md#taildocs-start).
...
1. Page limit handling has been improved during `taildocs start` mode.
1. Include [`description`](/configuration/page.md#description) in search index.
+++ Fixed :icon-bug:
1. Unable to scroll sidebar when navigating to a collapsed clickable sidebar menu. See [#128](https://github.com/taildocsapp/taildocs/issues/128).
1. Double-quote in image caption is not encoded. See [#245](https://github.com/taildocsapp/taildocs/discussions/245).
1. Build fails if root taildocs.yml configuration file is blank. See [#257](https://github.com/taildocsapp/taildocs/discussions/257).
1. Super mega long word in page title causes rendering issue. See [#253](https://github.com/taildocsapp/taildocs/issues/253).
1. Prevent float elements from interacting with Previous|Next buttons. See [#232](https://github.com/taildocsapp/taildocs/issues/232).
1. Unreliable sidebar and Prev/Next button label word wrapping. See [#253](https://github.com/taildocsapp/taildocs/issues/253).
1. Full width [Callout](/components/callout.md) component content. See [#242](https://github.com/taildocsapp/taildocs/issues/242).
1. Strange link resolution `WARNING` on emphasized markdown links. See [#291](https://github.com/taildocsapp/taildocs/issues/291).
+++

## v1.11.2

**Released:** [2021-12-23](https://github.com/taildocsapp/taildocs/releases/tag/v1.11.2)
...
**Released:** [2021-12-02](https://github.com/taildocsapp/taildocs/releases/tag/v1.11.1)

+++ Fixed :icon-bug:
1. Badges configured without a link `[!badge x]` are being ignored.
1. Horizontal scroll issue with wide table. See [#192](https://github.com/taildocsapp/taildocs/issues/192).
1. Relax client integrity verification rules. See [#225](https://github.com/taildocsapp/taildocs/issues/225) and [#226](https://github.com/taildocsapp/taildocs/issues/226).
1. Corrupted website config error appears on first load after rebuild. See [#212](https://github.com/taildocsapp/taildocs/issues/212) and [#226](https://github.com/taildocsapp/taildocs/issues/226).
+++

## v1.11.0

**Released:** [2021-11-19](https://github.com/taildocsapp/taildocs/releases/tag/v1.11.0)
...
**Released:** [2021-09-30](https://github.com/taildocsapp/taildocs/releases/tag/v1.10.0)
...
**Released:** [2021-08-30](https://github.com/taildocsapp/taildocs/releases/tag/v1.9.0)

+++ New :icon-shield-check:
1. Incremental build during [`taildocs start`](/guides/cli.md#taildocs-start) with page dependency graph
1. Ability to run `taildocs start` with in-memory output. Turned on by default, see [`serve.start.mode`](/configuration/project.md) to configure.
1. Platform specific NPM packages:
  1. [`taildocsapp-win-x86`](https://www.npmjs.com/package/taildocsapp-win-x86)
  2. [`taildocsapp-win-x64`](https://www.npmjs.com/package/taildocsapp-win-x64)
  3. [`taildocsapp-linux-x64`](https://www.npmjs.com/package/taildocsapp-linux-x64)
  4. [`taildocsapp-darwin-x64`](https://www.npmjs.com/package/taildocsapp-darwin-x64)
1. Lazy Prism and Mermaid plugin execution for hidden content
1. Keep scroll position on full page reload during [`taildocs start`](/guides/cli.md#taildocs-start).
...
**Released:** [2021-08-06](https://github.com/taildocsapp/taildocs/releases/tag/v1.8.2)
...
**Released:** [2021-08-05](https://github.com/taildocsapp/taildocs/releases/tag/v1.8.1)

+++ New :icon-shield-check:
1. Add broader checks for unresolved links, see [#112](https://github.com/taildocsapp/taildocs/issues/112). For instance, if a link to `../components` is created, TailDocs will now try to resolve the path to any of the following:
```
../components.md
../components/index.md
...
**Released:** [2021-08-03](https://github.com/taildocsapp/taildocs/releases/tag/v1.8.0)

+++ New :icon-shield-check:
1. [**taildocs.yml**](/configuration/project.md) project configuration file format.
...
**Released:** [2021-06-24](https://github.com/taildocsapp/taildocs/releases/tag/v1.7.0)
...
1. [`target`](/configuration/project.md#target) config for all `links` within **taildocs.yml**.
...
**Released:** [2021-06-09](https://github.com/taildocsapp/taildocs/releases/tag/v1.6.0)
...
+++ New :icon-shield-check:
1. Even cleaner upgrade to TailDocs from GitBook experience
1. Super fast [`taildocs start`](/guides/cli.md#taildocs-start) incremental build process
1. [image alignment](/components/image.md#alignment-options) and captions
1. [`exclude`](/configuration/project.md#exclude) config for **taildocs.yml**
...
+++ New :icon-shield-check:
1. GitHub [Actions](/guides/github-actions.md) for TailDocs.
...
1. [`favicon`](/configuration/project.md#favicon) Project config available in **taildocs.yml**.
+++
...
1. [`taildocs start`](/guides/cli.md#taildocs-start) command.
1. Live Reload when using [`taildocs start`](/guides/cli.md#taildocs-start).
